  ...
  return (
    <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 shadow-lg">
      ...
      <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-2 mb-4">
        ...
        />
        <button type="submit" className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md flex items-center justify-center transition-colors disabled:bg-gray-500 disabled:cursor-not-allowed min-w-[120px]" disabled={isLoading || !query.trim() || !client.googleDriveFolderUrl}>
          {isLoading ? (
            <>
      ...
      {(isLoading || result) && (
        <div className="bg-gray-900/50 p-4 rounded-md mt-4 border border-gray-700">
            {isLoading && <p className="text-gray-400">Syncing latest data & searching...</p>}
            {result && (
